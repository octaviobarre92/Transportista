...
const ModalDriverComponent = memo((props) => {
    const { type, saveData, editData, handleClose, show, dataSet, dataCompany, consult } = props;
                        ...
                        <Row>
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="first_name">
                                    ...
                                    <Form.Control disabled={consult ? true : false} defaultValue={dataSet.first_name} required type="text" placeholder="Example ->Productos S.A" />
                                </Form.Group>
                            </Col>
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="last_name">
                                    <Form.Label>Segundo Nombre</Form.Label>
                                    <Form.Control disabled={consult ? true : false} defaultValue={dataSet.last_name} required type="text" placeholder="Agregue un plan" />
                                </Form.Group>
                            </Col>
                            ...
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="phone">
                                    ...
                                    <Form.Control disabled={consult ? true : false} defaultValue={dataSet.phone} required type="text" placeholder="Agregue un plan" />
                                </Form.Group>
                            </Col>
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="email">
                                    <Form.Label>Email</Form.Label>
                                    <Form.Control disabled={consult ? true : false} defaultValue={dataSet.email} required type="email" placeholder="Agregue un plan" />
                                </Form.Group>
                            </Col>
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="avatar_url">
                                    <Form.Label>URL de avatar</Form.Label>
                                    <Form.Control disabled={consult ? true : false} defaultValue={dataSet.avatar_url} required type="text" placeholder="Agregue un plan" />
                            ...
                            <Col md="6">
                                <Form.Group className="mb-3" controlId="company_id">
                                    ...
                                    <Form.Select disabled={consult ? true : false} defaultValue={dataSet.company_id} required name="company_id" aria-label="Default select example">
